...
class BaseLine_LightBlock(nn.Module):
    def __init__(self, group=1):
        super(BaseLine_LightBlock, self).__init__()
        ...
        self.output = nn.Sequential(
            # nn.Conv2d(in_channels=12, out_channels=5, kernel_size=(1, 1), stride=(1, 1)),
